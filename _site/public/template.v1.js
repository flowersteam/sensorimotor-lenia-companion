...
var html$1 = "\n<style>\n  dt-banner {\n    background: #FFF59D;\n    display: block;\n    text-align: center;\n    color: black;\n    height: 70px;\n    line-height: 70px;\n  }\n</style>\n<div>This article is a draft</div>\n";
...
var citation = function(dom, data) {
  ...
  var appendCiteHoverDiv = (function() {
    ...
    return function appendHoverDiv(content) {
      ...
      hover_n += 1;
      var str = "<div style=\"display:none;\" class=\"dt-hover-box ref-box\" id=\"" + id + "\" >" + content + "</div>";
...
var footnote = function(dom, data) {
  ...
  var appendFootnoteHoverDiv = (function() {
    ...
    return function appendHoverDiv(content) {
      ...
      hover_n += 1;
      var str = "<div style=\"display:none;\" class=\"dt-hover-box fn-box\" id=\"" + id + "\" >" + content + "</div>";
      var div = nodeFromString(str);
      hover_boxes_container.appendChild(div);
      return id;
    }
  ...
  fnTags.forEach(function (el,n) {
    ...
    el.innerHTML = "<sup style='line-height: 0em;font-size:large'><span id=\"" + key + "\" data-hover-ref=\"" + ref_id + "\" style=\"cursor:pointer\">" + n + "</span></sup>";
  });
